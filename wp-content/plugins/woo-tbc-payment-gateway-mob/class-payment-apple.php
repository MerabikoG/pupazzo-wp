<?php
class WC_Apple_Pay_Gateway extends WC_Payment_Gateway {
  ...
  public function __construct() {
    ...
    $this->method_description = 'Description of Apple Pay payment gateway';
    ...
    add_action('woocommerce_api_redirect_to_payment_form_apple', array($this, 'redirect_to_payment_form'));
   ...
   public function init_form_fields() {
    ...
    $this->form_fields = array(
      'enabled' => array(
        ...
        'label'       => 'Enable Apple Pay Gateway',
        'type'        => 'checkbox',
        'description' => '',
        'default'     => 'no'
      ),
      ...
      'description' => array(
        ...
        'default'     => 'Pay with your Apple Pay via our super-cool payment gateway.',
      ),
      'merchant_host' => array(
        'title'       => 'Merchant host',
        'type'        => 'select',
  ...
  public function get_payment_form_url($trans_id) {
    return sprintf('%s/wc-api/redirect_to_payment_form_apple?merchant_host=%s&transaction_id=%s', get_bloginfo('url'), $this->get_option('merchant_host'), rawurlencode($trans_id));
  }
