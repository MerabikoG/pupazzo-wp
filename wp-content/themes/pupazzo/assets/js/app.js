  ...
  var Init = {
        ...
        $(".price-slider").ionRangeSlider({
          ...
          onFinish(event) {
            ...
            if (window.location.href.indexOf("min") > -1) {
              url.searchParams.set('min', event.from);
              url.searchParams.set('max', event.to);
            } else {
              url.searchParams.append('min', event.from);
              url.searchParams.append('max', event.to);
            }
    ...
    quantityHandle: function () {
      $(".decrement").on("click", function () {
        var qtyInput = $(this).closest(".quantity").children(".number");
